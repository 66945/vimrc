...
" had been hot pink for some reason
exec "hi Function guifg=".white." gui=bold"
...
" NOTE: custom - alacritty shows the bar as fg
exec "hi TabLineFill guifg=".gray_900
exec "hi TabLineFill ctermfg=".cterm_zinc_gray_900
...
if has('nvim-0.8')
	...
	" gray_200
    exec "hi @constructor guifg=".hot_pink." gui=bold"
